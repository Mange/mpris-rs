...
pub trait OrgMprisMediaPlayer2TrackList {
    ...
    fn add_track(
        &self,
        uri: &str,
        after_track: dbus::Path<'_>,
        set_as_current: bool,
    ) -> Result<(), dbus::Error>;
    fn remove_track(&self, track_id: dbus::Path<'_>) -> Result<(), dbus::Error>;
    fn go_to(&self, track_id: dbus::Path<'_>) -> Result<(), dbus::Error>;
